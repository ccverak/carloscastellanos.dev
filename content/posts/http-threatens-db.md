...
description: "The case when HTTP threatens the Database"
---
...
![Push systems could overwhelm the capacity of the receiver when the producer is faster than the consumer creating bottlenecks.](https://cdn-images-1.medium.com/max/2000/1*qlI73q1_VWPykF3qIIjWaw.png)
...
![All the requests that entered the system will hit the Database at a high rate, causing an outage eventually.](https://cdn-images-1.medium.com/max/2000/1*WIkI07Yb1poCVD9wIAMWqw.png)
...
![Pull systems have a steady flow that provides predictability. The consumer processes things at its own pace.](https://cdn-images-1.medium.com/max/2000/1*VbSVT4qqHkUoKTfXqh0rxw.png)
...
![The contention service allows to propagate events at regulated speed avoiding downstream services from going over capacity](https://cdn-images-1.medium.com/max/2000/1*5w9xYhmLDhUohtmWBHMF-A.png)
